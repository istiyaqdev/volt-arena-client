    ...
    return (
        <div className='w-11/12 mx-auto my-9'>
            <div className='md:w-1/2 mx-auto'>
                <h1 className="text-3xl font-extrabold uppercase tracking-tight text-white">Add a Facility</h1>
                <p className='text-slate-400'>Reach thousands of players in your city.</p>
            </div>

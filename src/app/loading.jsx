...
const Loading = () => {
    return (
        <div className="relative min-h-screen flex flex-col items-center justify-center px-6 py-10 overflow-hidden bg-(--noir)">
            ...
            >
                <rect x="40" y="40" width="600" height="440" rx="8" fill="none" stroke="#8b5cf6" strokeWidth="2.5" />
                <line x1="340" y1="40" x2="340" y2="480" stroke="#8b5cf6" strokeWidth="1.5" />
                <circle cx="340" cy="260" r="70" fill="none" stroke="#8b5cf6" strokeWidth="1.5" />
                <circle cx="340" cy="260" r="4" fill="#8b5cf6" />
                <rect x="40" y="155" width="100" height="210" rx="4" fill="none" stroke="#8b5cf6" strokeWidth="1.5" />
                <rect x="540" y="155" width="100" height="210" rx="4" fill="none" stroke="#8b5cf6" strokeWidth="1.5" />
                <rect x="40" y="200" width="45" height="120" rx="2" fill="none" stroke="#8b5cf6" strokeWidth="1" />
                <rect x="595" y="200" width="45" height="120" rx="2" fill="none" stroke="#8b5cf6" strokeWidth="1" />
            </svg>
                ...
                <div className="relative mb-6 flex h-[76px] w-[76px] items-center justify-center">
                    ...
                    <div
                        ...
                        style={{
                            ...
                            animation: "loading-spin 1.8s cubic-bezier(0.4, 0, 0.2, 1) infinite",
                        }}
                    />

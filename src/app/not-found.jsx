  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-10 relative overflow-hidden">
      ...
      <svg width="56" height="56" viewBox="0 0 56 56" className="mt-5">
        ...
        />
        <polygon
          points="28,10 35,20 45,20 39,28 42,39 28,33 14,39 17,28 11,20 21,20"
          fill="none"
          stroke="#354024"
          strokeWidth="1.2"
      ...
      {/* Text */}
      <h1 className="text-2xl font-bold text-[#382c11] mt-5 text-center">
        This page is offside
      </h1>
      <p className="text-[#6C696D] text-sm mt-2 text-center max-w-sm leading-relaxed">
        Looks like the page you're looking for has left the pitch. It may have
      ...
      <div className="flex gap-3 mt-8 flex-wrap justify-center">
        <Link
          href="/"
          className="flex items-center gap-2 bg-[#354024] text-[#E5D7C4] px-7 py-2.5 rounded-xl text-sm font-semibold hover:bg-[#889063] transition-colors"
        >
          <FaHome className="h-4 w-4" /> Back to home
        </Link>
        <Link
          href="/facilities"
          className="flex items-center gap-2 border-[1.5px] border-[#889063] text-[#354024] px-7 py-2.5 rounded-xl text-sm font-semibold hover:bg-[#E5D7C4] transition-colors"
        >

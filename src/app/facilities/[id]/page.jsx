                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-wrap items-start justify-between gap-3">
                            <div className="space-y-2">
                                ...
                                <h1 className="text-3xl font-black tracking-tight text-white uppercase">{facilityName}</h1>
                                <div className="flex flex-wrap items-center gap-4 text-sm text-slate-400">
                                    <span className="flex items-center gap-1.5">
                                        <svg className="w-4 h-4 text-[#ccff00]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                            ...
                            <div className="text-right">
                                <span className="text-3xl font-black text-[#ccff00]">${price}</span>
                        ...
                        <div className="space-y-3">
                            <h3 className="font-extrabold text-white text-sm uppercase tracking-wide">Available time slots</h3>
                            <div className="flex flex-wrap gap-2">
                                {slotsArray.map((slot, i) => (
                                    ...
                                    >
                                        <svg className="w-3 h-3 text-[#ccff00]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>

        ...
        <div className="flex flex-col items-center justify-center py-10 gap-5 text-center">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-sm text-slate-400 max-w-xs">
              You haven't booked any facility yet. Explore facilities and plan
              your next{" "}
        ...
        <>
              ...
              <tbody className="divide-y divide-slate-800/60 bg-[#0b0f19]">
                {bookings.map((booking) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-4 font-bold text-[#ccff00]">
          ...
          <div className="flex flex-col gap-4 md:hidden">
            {bookings.map((booking) => (
              <div
                key={booking._id}
                className="rounded-2xl border border-slate-800 bg-[#0b0f19] p-4 space-y-4"
              >
                <div className="flex items-center gap-3">
                  {booking.imageUrl && (
                    <Image
